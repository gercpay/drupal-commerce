...
namespace Drupal\commerce_gercpay\api;

/**
 * Class GercpayAPI. Utility class for interacting with GercPay API.
 *
 * @package Drupal\commerce_gercpay\api
 */
class GercpayAPI {
  ...
  /**
   * Allowed GercPay payment page languages.
   *
   * @since 3.8.0
   */
  protected const ALLOWED_PAYMENT_PAGE_LANGUAGES = [
      'ua' => 'UA',
      'ru' => 'RU',
      'en' => 'EN',
  ];
  ...
  public function getApiKey(): array {
    $config = \Drupal::service('config.factory')
      ->getEditable('commerce_payment.commerce_payment_gateway.gercpay_payment')
      ->get();
